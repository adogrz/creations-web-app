export function getWhatsappLink(whatsappNumber: string, costumeUrl?: string): string {
...
export function getMessengerLink(messengerHandle: string, costumeUrl?: string): string {
...
export function getInstagramLink(instagramHandle: string | null, costumeUrl?: string): string | null {
